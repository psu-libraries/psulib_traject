...
RSpec.describe 'Macros spec:' do
  ...
  describe 'process_media_types' do
    ...
    it 'works with empty record, return empty media type' do
      ...
      @empty_record.append(MARC::ControlField.new('001', '000000000'))
      result = @indexer.map_record(@empty_record)
      expect(result['media_type_facet_sim']).to be_nil
    end
    ...
    it 'correctly sets 949a media types' do
      ...
      expect(result['media_type_facet_sim']).to contain_exactly 'Blu-ray', 'DVD'
    end
    ...
    it 'correctly sets media type as Microfilm/Microfiche from 007' do
      ...
      expect(result['media_type_facet_sim']).to contain_exactly 'Microfilm/Microfiche'
    end
    ...
    it 'correctly sets media type as Photo from 007' do
      ...
      expect(result['media_type_facet_sim']).to contain_exactly 'Photo'
    end
    ...
    it 'correctly sets media type as Wire recording from 007' do
      ...
      expect(result['media_type_facet_sim']).to contain_exactly 'Wire recording'
    end
    ...
    it 'correctly sets media type as 78 rpm disc from 007' do
      ...
      expect(result['media_type_facet_sim']).to contain_exactly '78 rpm disc'
    end
    ...
    it 'correctly sets media type as Videocassette (Beta) from 007' do
      ...
      expect(result['media_type_facet_sim']).to contain_exactly 'Videocassette (Beta)'
    end
    ...
    it 'correctly sets media type as Other video from 007' do
      ...
      expect(result['media_type_facet_sim']).to contain_exactly 'Other video'
    end
    ...
    it 'correctly sets media type as DVD from 538a' do
      ...
      expect(result['media_type_facet_sim']).to contain_exactly 'DVD', 'Blu-ray'
    end
    ...
    it 'correctly sets media types from 300' do
      ...
      expect(result['media_type_facet_sim']).to contain_exactly 'MPEG-4', 'Piano/Organ roll', 'Video CD', 'Microfilm/Microfiche'
    end
  end
end
