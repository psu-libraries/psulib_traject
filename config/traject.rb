...
to_field 'title_latin_display_ssm', extract_marc('245abcfghknpsz', alternate_script: false), trim_punctuation
to_field 'title_vern', extract_marc('245abcfghknpsz', alternate_script: :only), trim_punctuation
