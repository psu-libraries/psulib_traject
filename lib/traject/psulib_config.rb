...
hathi_mono_overlap_csv = "#{settings['hathi_overlap_path']}#{settings['hathi_mono_overlap_file']}"
Traject::Macros::Custom::HATHI_MONO_OVERLAP = CSV.read(hathi_mono_overlap_csv).map { |oclc, ht_id, access| [oclc, { ht_id: ht_id, access: access }] }.to_h

hathi_multi_overlap_csv = "#{settings['hathi_overlap_path']}#{settings['hathi_multi_overlap_file']}"
Traject::Macros::Custom::HATHI_MULTI_OVERLAP = CSV.read(hathi_multi_overlap_csv).map { |oclc, ht_bib_key, access| [oclc, { ht_bib_key: ht_bib_key, access: access }] }.to_h
